...
<img src="./header-terminal.svg?v=1" alt="Michela - computer science student at UniNA, software developer" />
...
I'm a Computer Science student at the **University of Naples Federico II** and a **software developer**.

I build secure, scalable web applications — and spend the rest of my time going as far down the stack as I can. Web security and low-level programming are the two ends of the same curiosity: figuring out what actually happens underneath the abstraction.
...
```
~/stack
├── backend/     java · spring boot · php · laravel · node · express
├── frontend/    react · javascript · tailwind · bootstrap · vite
├── database/    mysql · sql
├── low-level/   c · c++ · python
└── tools/       docker · git · postman · npm
```

<br>

Same thing, with badges
